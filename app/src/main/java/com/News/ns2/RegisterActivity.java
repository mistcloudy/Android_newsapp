...
//import com.example.ns2.ui.login.LoginActivity;

import org.json.JSONException;
import org.json.JSONObject;

public class RegisterActivity extends AppCompatActivity {
    private EditText join_email, join_password, join_name, join_pwck; // 회원 가입시 입력 정보
    private Button join_button, check_button, delete_button; // 회원가입 체크 버튼
    private AlertDialog dialog; //다이얼로그 선언
    private boolean validate = false; // valdate false 값 설정
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (UserEmail.equals("")) { //아이디값이 안들어 있으면
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                validate = true; //검증 완료
                                check_button.setBackgroundColor(getResources().getColor(R.color.design_default_color_on_primary));
                            }
                            else {
                                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
