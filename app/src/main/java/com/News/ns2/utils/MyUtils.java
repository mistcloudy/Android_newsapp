    ...
    public static String getRealPath(Context context, Uri uri) {
      ...
      /*  String realPath;
        ...
        if (Build.VERSION.SDK_INT < 11) {
            realPath = MyUtils.getRealPathFromURI_BelowAPI11(context, uri);
        }

        // SDK >= 11 && SDK < 19
        else if (Build.VERSION.SDK_INT < 19) {
            realPath = MyUtils.getRealPathFromURI_API11to18(context, uri);
        }

        // SDK > 19 (Android 4.4)
        else {
            realPath = MyUtils.getRealPathFromURI_API19(context, uri);
        }
        return realPath;*/
